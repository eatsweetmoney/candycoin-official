...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CandyCoin " + FormatFullVersion();
...
// The second name should resolve to a list of seed addresses.						//*TODO*
static const char *strMainNetDNSSeed[][2] = {
    {"candyco.in","dnsseed.candyco.in"}, //	OFFICIAL SITE
//    {"yyyyy.tld","dnsseed.yyyyy.tld"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CandyCoin is probably already running."), addrBind.ToString().c_str());
        else
