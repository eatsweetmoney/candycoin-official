...
uint256 hashGenesisBlock("0x33376fcd611ad6c9f7c6699217b33758fa4824bf3ffcc57676bc9fc59119c71e");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // CandyCoin: starting difficulty
...
const string strMessageMagic = "CandyCoin Signed Message:\n";
...
{
    // CandyCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 1.5 * 24 * 60 * 60;
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // CandyCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // CandyCoin: Special short-term limits to avoid 10,000 BDB lock limit:
    if (GetBlockTime() < 1380603600)  // stop enforcing 15 October 2013 00:00:00
    {
        ...
        if (nTxids > 4500)
            return error("CheckBlock() : 15 October maxlocks violation");
    }
...
{
    // CandyCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x33376fcd611ad6c9f7c6699217b33758fa4824bf3ffcc57676bc9fc59119c71e");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block
        const char* pszTimestamp = "NYT 31/Mar/2014 Hobie Alter, Innovator of Sailing and Surfing, Dies at 80";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04cb932807e9fa755720776ea096d8ad12ee2c2c1ac7ee4da70cd20c677a8610e426e3fb8c7bcd138ee88213923fc4f6ebd8849de2e9e97290cb92fba5327bbe49") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1396321383;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2088674320;

        if (fTestNet)
        {
            block.nTime    = 1396072425;
            block.nNonce   = 1426952;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x283693a46ae10ce25e93b46e65dbc82d214ff69dbd4f9a3699a6d6063d65d31d"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf8, 0xa9, 0xb4, 0xf0 }; // CandyCoin
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CandyCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CandyCoinMiner : ProcessBlock, block not accepted");
    }
